              ...
              //  alert(DataAry[1])
               // alert(DataAry);
                $.post('class/getData_HomeChart1.php', { userpara: DataAry }, function(json_data2) 
                {
                    ...
                    // for(var i=0;i<line1A_Length;i++){
                    //     //alert(res.Data_Ary4[i])
                    //     line1A_Data.push(res.Data_Ary3[i]);
                    //     line1A_Time.push(res.Data_Ary4[i]);
                    // }
                    ...
                    plugins: [{
                        ...
                        ctx.fillText(res.Data_Ary[4]+' Pa', chart.width - 10, 30); // Adjust position as needed
                        ctx.restore();
                    }
                         }]
