    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-4">                            
                    <div class="card card-success card-body d-flex flex-column justify-content-center align-items-center" style="height: 225px; width: 100%;">
                            <div class="text-center" style="font-size: 22px; font-weight: bold;">Total kW</div>
                            <div id="id_Home_units" class="text-center mt-3" style="font-size: 22px; font-weight: bold;">- -</div>

                            <div class="text-center text-warning mt-3" style="font-size: 12px; font-weight: bold;">Last Updated Time MFM</div>
