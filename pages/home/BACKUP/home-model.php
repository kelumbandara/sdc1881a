    ...
    <div class="content-wrapper">
        ...
        <section class="content" id="content">
            <h5>Dashboard</h5>
               ...
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="luwa_1A_model('Luwa_1A')">Large modal</button>
                    ...
                    <div class="col">
                        ...
                        <div class="">
                            <div  class="flexbox" id="id_flexbox">
                                <div class="chartBox" style="position: relative; height:23vh; width:25vw">
