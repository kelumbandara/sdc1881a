                ...
                $.post('class/getData_HomeChart1.php', { userpara: DataAry }, function(json_data2)
                {
                   ...
                   console.log(json_data2)
                        ...
                        try{
                            ...
                            if(line1A_Data.length >= 1)
                            {
                                //alert(line1A_Data.length)
                                Chart1_Display_Time=line1A_Time;
                            ...
                            if(line1A_Data.length == 1 && line1B_Data.length > 1 )
                            {
                                
                                Chart1_Display_Time=line1B_Time;
                                New_1B=line1B_Data;
                ...
                console.log(line4B_Time);
                    ...
                    try
                    {
                        ...
                        //Find Last Value   
                            ...
                            let New_1B_lastValue = New_1B[New_1B.length - 1] === undefined ? 0 : New_1B[New_1B.length - 1];
                            let New_2B_lastValue = New_2B[New_2B.length - 1] === undefined ? 0 : New_2B[New_2B.length - 1];
                            let New_3B_lastValue = New_3B[New_3B.length - 1] === undefined ? 0 : New_3B[New_3B.length - 1];
                            let New_4B_lastValue = New_4B[New_4B.length - 1] === undefined ? 0 : New_4B[New_4B.length - 1];
                            let New_5B_lastValue = New_5B[New_5B.length - 1] === undefined ? 0 : New_5B[New_5B.length - 1];
                            let New_6B_lastValue = New_6B[New_6B.length - 1] === undefined ? 0 : New_6B[New_6B.length - 1];
                            let New_7B_lastValue = New_7B[New_7B.length - 1] === undefined ? 0 : New_7B[New_7B.length - 1];
                            let New_8B_lastValue = New_8B[New_8B.length - 1] === undefined ? 0 : New_8B[New_8B.length - 1];
                            let New_9B_lastValue = New_9B[New_9B.length - 1] === undefined ? 0 : New_9B[New_9B.length - 1];
                            let New_10B_lastValue = New_10B[New_10B.length - 1] === undefined ? 0 : New_10B[New_10B.length - 1];
                            let New_11B_lastValue = New_11B[New_11B.length - 1] === undefined ? 0 : New_11B[New_11B.length - 1];
                            let New_12B_lastValue = New_12B[New_12B.length - 1] === undefined ? 0 : New_12B[New_12B.length - 1];
                            let New_13B_lastValue = New_13B[New_13B.length - 1] === undefined ? 0 : New_13B[New_13B.length - 1];
                            let New_14B_lastValue = New_14B[New_14B.length - 1] === undefined ? 0 : New_14B[New_14B.length - 1];
                            let New_15B_lastValue = New_15B[New_15B.length - 1] === undefined ? 0 : New_15B[New_15B.length - 1];
                            let New_16B_lastValue = New_16B[New_16B.length - 1] === undefined ? 0 : New_16B[New_16B.length - 1];
                            let New_17B_lastValue = New_17B[New_17B.length - 1] === undefined ? 0 : New_17B[New_17B.length - 1];
                            let New_18B_lastValue = New_18B[New_18B.length - 1] === undefined ? 0 : New_18B[New_18B.length - 1];
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                  ...
                                  //  ctx.fillText(res.Data_Ary[last_value_Line_1A]+' Pa', chart.width - 10, 30); // Adjust position as needed
                                    ...
                                    ctx.fillText(New_1B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_2B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_3B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_4B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_5B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_6B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_7B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_8B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_9B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_10B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_11B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_12B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_13B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_14B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_15B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
                        ...
                        [
                            {
                                ...
                                beforeDraw: (chart) =>
                                {
                                    ...
                                    // Additional Drawing
                                    ctx.fillStyle = 'rgb(0, 255, 8)'; // Change color for distinction
                                    ctx.fillText(New_16B_lastValue + ' Pa', chart.width -10, 20); // Adjust position
                                    ctx.restore();
                                }
