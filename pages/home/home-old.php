            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">                            
                            <div class="card card-success card-body d-flex flex-column justify-content-center align-items-center">
                                <table >
                                    <tr>
                                        <td style=" font-size: 20px; font-weight: bold;">Total kW</td>
                                        <td id="id_Home_units" style=" font-size: 29px; font-weight: bold;">- -</td>
                                    </tr>
                                    <tr>
                                        <td style="color: #f5e342; font-size: 15px; font-weight: bold;">Last Update Date Time MFM</td>
                                        <td id="id_Home_LstUpDateTime_MFM" style="color: #f5e342; font-size: 15px; font-weight: bold;" >- -</td>
                                    </tr>
                                    <tr>
                                        <td style="color: #f5e342; font-size: 15px; font-weight: bold;">Last Update Date Time MFI</td>
                                        <td id="id_Home_LstUpDateTime_MFI" style="color: #f5e342; font-size: 15px; font-weight: bold;" >- -</td>
                                    </tr>
                                </table>
                            </div>                            
                        </div> 
                        <div class="col-4">
                            <div class="card">
                                ...
                                <!-- Group 1 -->
                                <div id="group-1" class="heading-group">
                                <div class="card-header" style="background-color: #707070 ; padding-top: 3px; padding-bottom: 3px; line-height: 1.2;"><center>CHILLERS</center>
                                    <div class="row" style="display: flex; justify-content: center; align-items: center;">
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="1">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_0" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">
                                                    
                                                        <center><h6 id='id_mcspeed_0'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="2">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_1" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">                                                      
                                                        <center><h6 id='id_mcspeed_1'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="3">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_1" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">
                                                        <center><h6 id='id_mcspeed_2'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="4">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_1" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">
                                                        <center><h6 id='id_mcspeed_3'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Group 2 -->
                                <div id="group-2" class="heading-group">
                                <div class="card-header" style="padding-top: 3px; padding-bottom: 3px; line-height: 1.2;"><center>CHILLER PUMP</center>
                                    <div class="row" style="display: flex; justify-content: center; align-items: center;">
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="5">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_4" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">
                                                        <center><h6 id='id_mcspeed_4'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg2 col-xs-3">
                                            <div id="6">
                                                <div class="small-box mx-2">
                                                    <div id="id_color_5" style="background-color: red; width:60px; height: 40px; border-radius: 10px; border: 1px solid black; display: flex; justify-content: center; align-items: center; color: black;">
                                                        <center><h6 id='id_mcspeed_5'>OFF</h6></center>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Group 3 -->
                                <div id="group-3" class="heading-group">
                                ...
                                <!-- Group 4 -->
                                <div id="group-4" class="heading-group">
...
//--------------- Admin Panel Minimize ----------------------
    ...
    //alert("Start Code.- 1");
    $('.js-gauge--2').kumaGauge({value : Math.floor((Math.random() * 599) + 1)});
