    ...
    <div class="modal-dialog">      
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row p-1">                    
                    <div class="col-md-12">                   
                        ...
                        <select class="form-control select2" id="id_ModRedTagCre_SelRedTagCategory" style="width: 100%;">
                            ...
                            <option selected="none">Rust/Corrosion</option>  
                            <option selected="none">Contamination</option>  
                ...
                <div class="row p-1">   
                    <div class="col-md-6">
                        <input type="datetime-local" id="id_ModRedTagCre_dtmDateTime" class="form-control" name="startDate" required/>                           
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-footer bg-light">
                <button type="submit" class="btn btn-primary" onclick="funModRedTagCre_Update()" >Update</button>
