            ...
            else
            {
                ...
                {             
                    ...
                    if(res.LoginDetailAry[0] === "Success")
                    {
                        ...
                        if(res.user_roll_sections[0] === "10"){
                            window.location.href = "./home/home.php";
                            //window.close();
                            //window.open("./home.php");
                            //alert("OK.!");
                        }
                        else if(res.user_roll_sections[0] === "14"){
                            window.location.href = "./home/homeMFM.php";
                        }
                        else if(res.user_roll_sections[0] === "17"){
                            window.location.href = "./home/homeMFI.php";
                        }
                        else{
                            window.location.href = "./home/home.php";
                        }
