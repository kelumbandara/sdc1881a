    ...
    if MAC_Available_Database==1:
        ...
        if(msg_payload_have_event==1):
            ...
            if(lists==expected_json_format_1 ):   #Event Data
                ...
                # thread1 = threading.Thread(target=Timer(MacAdd,client))
                # thread2 = threading.Thread(target=Timer_event_air_flow(MacAdd,client))
...
def Timer_event_air_flow(MacAdd,client):
    ...
    print("_fdef Timer_event_airlow")
    return 1
