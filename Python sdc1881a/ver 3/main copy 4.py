...
def on_message(client, userdata, msg):
    ...
    if MAC_Available_Database==1:
        ...
        if(lists==expected_json_format_2 ):
            ...
            PwrOnMSG(MAC,UnitID,ServerDateTime)
...
def PwrOnMSG(MAC,UnitID,ServerDateTime):
    ...
    cursor = connection.cursor()
    sql_query = """INSERT INTO tblmc_devicepoweron (UnitID,MAC_Address,ServerDateTime)VALUES (%s,%s,%s)"""
    cursor.execute(sql_query, (UnitID,MAC,ServerDateTime))
    ...
    try:
        ...
        if not rows:  # Check if rows are empty
            ...
            for row in rows:
                ...
                last_data_insert_time_event=0
                print("last_data_insert_time_event ",last_data_insert_time_event)
                ...
                try:
                    ...
                    if rows == " ":
                        print("No data found Event table.  return 1")
                        #return 1
                        insertRecord_event_air_flow(first_sensor_value,second_sensor_value)
                    ...
                    if rows:
                        for row in rows:
                            ...
                            last_data_insert_time_event=row[0]
                            

                            #print("last_data_insert_time:",last_data_insert_time)  # row[0] contains the first column value
                            
                    else:
                        print("No data found Event table.. last_data_insert_time")
                        print(" ")
                        insertRecord_event_air_flow(first_sensor_value,second_sensor_value)
                ...
                try:
                    ...
                    if DebugEnable == 1:
                        print("Retrieved last ServerDateTime:", last_data_insert_time_event)
                ...
                #     last_data_insert_time_add_5_min=last_data_insert_time_event+timedelta(seconds=15)
                #     print("last_data_insert_time_add_5_min : ",last_data_insert_time_event)
                ...
                #     if(last_data_insert_time_add_5_min<formatted_datetime):
                #         print("Data Insert Event table  after 5min")
                #         #return 1
                #         insertRecord_event_air_flow(first_sensor_value,second_sensor_value)
